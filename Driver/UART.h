...
/*IPC Data Index*/
#define CHANNEL         0
#define SEQUENCE_MSB    1
#define SEQUENCE_LSB    2
#define COMMAND         3
#define START_OF_DATA   4
...
#define	_00_UARTF_LT_INT_GENTIME_0							0x00U	/* outputs transmission interrupt request upon transmission completion */
#define	_01_UARTF_LT_INT_GENTIME_1							0x01U	/* outputs transmission interrupt request upon transmission start */
...
#define	_000D_UARTF0_K_VALUE								0x000DU
/* Selection of 16-bit counter output clock (UF1BRS7 - UF1BRS0) */
#define	_000D_UARTF1_K_VALUE								0x000DU
/*
*******************************************************************************
**  Function define
*******************************************************************************
